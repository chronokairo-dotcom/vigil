 ...
 * automatically enriched with project context from Vigil.
 *
 * Available prompts:
...
export function registerPromptEndpoints(server: any) {
    ...
    server.prompt(
        ...
        {
            projectId: z.string().describe('Vigil project ID'),
                ...
                messages: [
                    {
                        ...
                        content: {
                            type: 'text',
                            text: `You are a senior engineer planning a safe refactoring for this project. The project uses Vigil's safety net (file snapshots + rollback).
...
- [ ] Snapshots to take (Vigil safety net)
...
- How to use Vigil snapshots for recovery`,
                        },
                    },
                ],
            };
...
- Context entries to add to Vigil for future reference
...
### 8. Who/What to Ask
(Where to find more info, how to use Vigil for context)`,
                        },
                    },
                ],
            };
    ...
    server.prompt(
        'context-sync-check',
        'Audit what project context might be missing, outdated, or incomplete. Helps keep Vigil context fresh and useful.',
        {
            projectId: z.string().describe('Vigil project ID'),
                ...
                messages: [
                    {
                        ...
                        content: {
                            type: 'text',
                            text: `You are a context quality auditor for this project's Vigil database. Analyze the current stored context and identify gaps.
...
(Prioritized list of context updates to make via Vigil tools)`,
                        },
                    },
                ],
            };
